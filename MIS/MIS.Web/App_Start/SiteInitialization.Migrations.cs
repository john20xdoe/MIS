namespace MIS
{
    ...
    {
        private static string[] databaseKeys = new[] { "Default", "Northwind", "Timekeeping" };
        ...
        private static void RunMigrations(string databaseKey)
        {
            ...
            // remove these lines if you want MIS migrations to run on your DB.
            ...
            using (var sw = new StringWriter())
            {
                ...
                var runner = new RunnerContext(announcer)
                {
                    ...
                    Namespace = "MIS.Migrations." + databaseKey + "DB"
                };
