    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your MIS Password";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your MIS Account";
                    ...
                    public static LocalText FormTitle = "Sign up for MIS";
