    ...
    (function (Northwind) {
        var TerritoryDialog = (function (_super) {
            ...
            TerritoryDialog.prototype.getLanguages = function () {
                return MIS.LanguageList.getValue();
            };
    ...
    (function (Northwind) {
        var ProductGrid = (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(MIS.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(MIS.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
    ...
    (function (Common) {
        var BulkServiceAction = (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new MIS.BasicProgressDialog();
...
(function (MIS) {
    ...
    (function (BasicSamples) {
        ...
        }(MIS.Common.BulkServiceAction));
        BasicSamples.OrderBulkAction = OrderBulkAction;
    })(BasicSamples = MIS.BasicSamples || (MIS.BasicSamples = {}));
})(MIS || (MIS = {}));
var MIS;
(function (MIS) {
    var Northwind;
    (function (Northwind) {
        var OrderDialog = (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                ...
                buttons.push(MIS.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: MIS.Authorization.userDefinition.DisplayName,
    ...
    (function (Northwind) {
        var CustomerDialog = (function (_super) {
            ...
            function CustomerDialog() {
                ...
                MIS.DialogUtils.pendingChangesConfirmation(this.element, function () { return _this.getSaveState() != _this.loadedState; });
...
(function (MIS) {
    ...
    })(Membership = MIS.Membership || (MIS.Membership = {}));
})(MIS || (MIS = {}));
var MIS;
(function (MIS) {
    var Membership;
...
(function (MIS) {
    ...
    (function (ScriptInitialization) {
        ...
        Q.Config.rootNamespaces.push('MIS');
    })(ScriptInitialization = MIS.ScriptInitialization || (MIS.ScriptInitialization = {}));
})(MIS || (MIS = {}));
var MIS;
(function (MIS) {
    var Common;
...
(function (MIS) {
    ...
    })(Administration = MIS.Administration || (MIS.Administration = {}));
})(MIS || (MIS = {}));
var MIS;
(function (MIS) {
    var Administration;
...
(function (MIS) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnum(Gender, 'MIS.Northwind.Entities.Gender');
    })(Northwind = MIS.Northwind || (MIS.Northwind = {}));
})(MIS || (MIS = {}));
var MIS;
(function (MIS) {
...
(function (MIS) {
    ...
    MIS.BasicProgressDialog = BasicProgressDialog;
})(MIS || (MIS = {}));
var MIS;
(function (MIS) {
    var DialogUtils;
    ...
    })(DialogUtils = MIS.DialogUtils || (MIS.DialogUtils = {}));
})(MIS || (MIS = {}));
var MIS;
(function (MIS) {
    var Common;
...
(function (MIS) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = MIS.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = MIS.LanguageList || (MIS.LanguageList = {}));
})(MIS || (MIS = {}));
var MIS;
(function (MIS) {
    var Common;
...
(function (MIS) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return MIS.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return MIS.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return MIS.Northwind.SalesByCategoryService.baseUrl; };
            /**
...
(function (MIS) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return MIS.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return MIS.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return MIS.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return MIS.Northwind.ProductService.baseUrl; };
    ...
    (function (BasicSamples) {
        var InitialValuesForQuickFilters = (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                var fld = MIS.Northwind.OrderRow.Fields;
                ...
                Q.first(filters, function (x) { return x.field == fld.ShippingState; }).init = function (w) {
                    ...
                    w.value = MIS.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(MIS.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new MIS.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new MIS.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new MIS.Northwind.OrderDialog().loadEntityAndOpenDialog({
                    ...
                    var countryFilter = this.findQuickFilter(Serenity.LookupEditor, MIS.Northwind.OrderRow.Fields.ShipCountry);
...
(function (MIS) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return MIS.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return MIS.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return MIS.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return MIS.Northwind.ProductService.baseUrl; };
            /**
            ...
            ConditionalFormattingGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = MIS.Northwind.ProductRow.Fields;
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return MIS.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (MIS) {
    ...
    (function (BasicSamples) {
        ...
        }(MIS.Northwind.OrderDetailsEditor));
...
(function (MIS) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return MIS.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return MIS.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return MIS.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return MIS.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                _super.call(this);
                this.form = new MIS.Northwind.OrderDetailForm(this.idPrefix);
                ...
                this.form.ProductID.cascadeField = MIS.Northwind.ProductRow.Fields.CategoryID;
        ...
        }(MIS.Northwind.OrderDetailDialog));
        ...
        var SerialAutoNumberDialog = (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    MIS.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
...
(function (MIS) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return MIS.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return MIS.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return MIS.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return MIS.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return MIS.Northwind.OrderService.baseUrl; };
        ...
        var PopulateLinkedDataDialog = (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(MIS.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    MIS.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return MIS.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return MIS.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return MIS.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return MIS.Northwind.OrderService.baseUrl; };
        ...
        var GetInsertedRecordIdDialog = (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew) {
                    ...
                    MIS.Northwind.CategoryService.Retrieve({
        ...
        var DefaultValuesInNewGrid = (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: MIS.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: MIS.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new MIS.Northwind.OrderDialog();
                        ...
                        var chai = MIS.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = MIS.Northwind.EmployeeRow.getLookup().items
...
(function (MIS) {
    ...
    })(Authorization = MIS.Authorization || (MIS.Authorization = {}));
})(MIS || (MIS = {}));
var MIS;
(function (MIS) {
    var Administration;
...
//# sourceMappingURL=MIS.Web.js.map