...
declare namespace MIS.Administration {
    class UserDialog extends Dialog<UserRow, any> {
        protected getFormKey(): string;
        protected getIdProperty(): string;
...
declare namespace MIS.Authorization {
...
declare namespace MIS.BasicSamples {
...
declare namespace MIS.Northwind {
    class ProductDialog extends Dialog<ProductRow, any> {
        protected getFormKey(): string;
        protected getIdProperty(): string;
        protected getLocalTextPrefix(): string;
        protected getNameProperty(): string;
...
declare namespace MIS.Northwind {
    class ProductGrid extends Grid<ProductRow, any> {
        protected getColumnsKey(): string;
...
declare namespace MIS.BasicSamples.DialogBoxes {
...
declare namespace MIS.ScriptInitialization {
}
declare namespace MIS {
...
declare namespace MIS.DialogUtils {
...
declare namespace MIS.LanguageList {
...
declare namespace MIS.Common.Pages {
...
declare namespace MIS.Membership {
...
declare namespace MIS.TimekeepingDB {
    class DtrDialog extends Serenity.EntityDialog<DtrRow, any> {
        protected getFormKey(): string;
        protected getIdProperty(): string;
        protected getLocalTextPrefix(): string;
        protected getService(): string;
        protected form: DtrForm;
    }
}
declare namespace MIS.TimekeepingDB {
    class DtrEditor extends Common.GridEditorBase<DtrRow> {
        protected getColumnsKey(): string;
        protected getDialogType(): typeof DtrEditorDialog;
        protected getLocalTextPrefix(): string;
        constructor(container: JQuery);
    }
}
declare namespace MIS.TimekeepingDB {
    class DtrEditorDialog extends Common.GridEditorDialog<DtrRow> {
        protected getFormKey(): string;
        protected getLocalTextPrefix(): string;
        protected form: DtrForm;
    }
...
declare namespace MIS.TimekeepingDB {
    class DtrGrid extends Serenity.EntityGrid<DtrRow, any> {
        protected getColumnsKey(): string;
        protected getDialogType(): typeof DtrDialog;
        protected getIdProperty(): string;
        protected getLocalTextPrefix(): string;
        protected getService(): string;
        constructor(container: JQuery);
